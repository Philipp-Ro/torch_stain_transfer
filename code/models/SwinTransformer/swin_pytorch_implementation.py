...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(
        ...
        self.mlp = torchvision.ops.misc.MLP(dim, [int(dim * mlp_ratio), dim], activation_layer=nn.GELU, inplace=None, dropout=dropout)
...
class SwinTransformer(nn.Module):
    ...
    def __init__(
        ...
        self.permute = torchvision.ops.misc.Permute([0, 3, 1, 2])  # B H W C -> B C H W
...
def test():
    ...
    model = _swin_transformer(patch_size =[16,16],
    embed_dim=64,
    depths= [6,6],
    num_heads= [4,4],
    window_size=[64,64],
